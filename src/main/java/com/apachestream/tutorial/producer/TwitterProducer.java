package com.apachestream.tutorial.producer;

import com.apachestream.tutorial.config.KafkaConfig;
import com.apachestream.tutorial.config.TwitterConfig;
...
public class TwitterProducer {
    ...
    private List<String> trackTerms = Lists.newArrayList("coronavirus","India");
